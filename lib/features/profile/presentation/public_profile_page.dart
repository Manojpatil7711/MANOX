...
class _PublicProfilePageState extends State<PublicProfilePage> {
  ...
  HomeDemoData _data(ManoxPost p) => HomeDemoData(
    id: p.id,
        ...
        child: ListView(
          ...
          children: [
            ...
            if (_posts.isEmpty)
              ...
              ..._posts.map((p) => Padding(padding: const EdgeInsets.only(bottom: 8), child: PostCard(data: _data(p), repository: _postsRepo, onChanged: _load))),
          ],
        ),
      );
    }
...
class _Stat extends StatelessWidget {
  ...
  @override Widget build(BuildContext context) => Column(children: [Text(value, style: const TextStyle(fontSize: 18, fontWeight: FontWeight.w800)), const SizedBox(height: 4), Text(label)]);
}
