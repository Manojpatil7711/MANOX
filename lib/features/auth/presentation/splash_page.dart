...
class _SplashPageState extends State<SplashPage> with TickerProviderStateMixin {
  late final AnimationController _tagline = AnimationController(
    vsync: this,
    duration: const Duration(milliseconds: 500),
  );
  late final AnimationController _brand = AnimationController(
    vsync: this,
  ...
  Widget build(BuildContext context) {
    ...
    final brandScale = Tween<double>(begin: .84, end: 1).animate(
      CurvedAnimation(parent: _brand, curve: Curves.easeOutBack),
    );
          ...
          children: [
            ...
            FadeTransition(
              ...
              child: ScaleTransition(
                scale: brandScale,
                child: const ManoxBrand(compact: false),
              ),
            ),
          ],
        ),
