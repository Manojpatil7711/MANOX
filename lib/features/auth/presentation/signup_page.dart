...
class _SignupPageState extends State<SignupPage> {
  ...
  Future<void> submit() async {
    ...
    try {
      ...
      if (mounted) {
        setState(() => error = 'Unable to create your account. Please try again.');
      }
    } finally {
              ...
              child: ConstrainedBox(
                ...
                child: Column(
                  children: [
                    ...
                    const Text(
                      'CHECK YOUR EMAIL',
                      style: TextStyle(fontSize: 27, fontWeight: FontWeight.w900, letterSpacing: 1.1),
                    ),
      ...
      body: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [
              scheme.surface,
              Color.alphaBlend(scheme.primary.withValues(alpha: 0.09), scheme.surface),
              scheme.surface,
            ],
          ),
        ),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                        ...
                        textAlign: TextAlign.center,
                        style: TextStyle(fontSize: 12, fontWeight: FontWeight.w800, letterSpacing: 3.0),
                      ),
                      ...
                      Row(
                        children: [
                          Expanded(
                            child: TextFormField(
                              controller: first,
                              decoration: fieldDecoration('First name', Icons.person_outline),
                          ...
                          Expanded(
                            child: TextFormField(
                              controller: surname,
                              decoration: fieldDecoration('Surname', Icons.badge_outlined),
                              validator: (v) => requiredField(v, 'Surname'),
                            ),
                          ),
                        ],
                      ),
                      ...
                      TextFormField(
                        controller: mobile,
                        decoration: fieldDecoration('Mobile number', Icons.phone_outlined),
                      ...
                      TextFormField(
                        ...
                        controller: email,
                        decoration: fieldDecoration('Email address', Icons.mail_outline),
                      ...
                      TextFormField(
                        ...
                        controller: confirm,
                        obscureText: true,
                        decoration: fieldDecoration('Confirm password', Icons.lock_reset_outlined),
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: loading
                              ...
                              : const Text('CREATE ACCOUNT', style: TextStyle(fontWeight: FontWeight.w800, letterSpacing: 1.0)),
                        ),
                      ),
