...
class _MessagesPageState extends State<MessagesPage> {
  ...
  void _addEmoji(String emoji) {
    final value = _controller.text + emoji;
    ...
    await showDialog<void>(
      ...
      builder: (dialog) => AlertDialog(
        ...
        content: TextField(
          ...
          autofocus: true,
          decoration: const InputDecoration(hintText: 'Username or profile'),
        ),
        actions: [
          TextButton(
          ...
          FilledButton(
            onPressed: () {
              ...
              if (name.isNotEmpty && mounted) {
                setState(() => _messages.add('Chat with $name'));
              }
            },
            ...
            SizedBox(
              ...
              child: GridView.builder(
                ...
                itemBuilder: (context, index) => InkWell(
                  ...
                  child: Center(
                    child: Text(_emojis[index], style: const TextStyle(fontSize: 25)),
                  ),
                ),
              ),
            ),
        ...
        body: ListView(
          children: const [
            ListTile(
              ...
              subtitle: Text('Your MANOX activity will appear here.'),
            ),
          ],
        ),
      );
