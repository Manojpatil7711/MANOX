...
class _YoutubeHomePageState extends State<YoutubeHomePage> {
  ...
  Widget _topBar() => Material(
    ...
    child: SafeArea(bottom: false, child: Padding(
      ...
      child: Row(children: [
        Container(width:36,height:36,decoration:BoxDecoration(color:Theme.of(context).colorScheme.onSurface,borderRadius:BorderRadius.circular(10)),alignment:Alignment.center,child:Text('M',style:TextStyle(color:Theme.of(context).colorScheme.surface,fontSize:22,fontWeight:FontWeight.w900))),
  ...
  Widget _sectionHeader()=>Padding(padding:const EdgeInsets.fromLTRB(12,10,8,4),child:Row(children:[Text(categories[_category],style:const TextStyle(fontSize:20,fontWeight:FontWeight.w900)),const Spacer(),IconButton(onPressed:_loadFeed,tooltip:'Refresh feed',icon:const Icon(Icons.refresh_rounded))]));
