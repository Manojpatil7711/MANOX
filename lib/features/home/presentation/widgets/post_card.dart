...
class _PostCardState extends State<PostCard> {
        ...
        child: DraggableScrollableSheet(
          ...
          builder: (_, controller) => ListView(
            ...
            children: [
              ...
              if (widget.data.imagePath != null) ...[const SizedBox(height: 16), _media(420)],
              const SizedBox(height: 16),
              _engagementRow(),
            ],
          ),
  ...
  Future<void> _showPostMenu() async {
    final c = await showModalBottomSheet<String>(context: context, builder: (context) => SafeArea(child: Column(mainAxisSize: MainAxisSize.min, children: [
      ...
      if (_isOwner) ...[
        const ListTile(leading: Icon(Icons.edit_outlined), title: Text('Edit post')),
        const ListTile(leading: Icon(Icons.delete_outline), title: Text('Delete post')),
      ],
    ])));
