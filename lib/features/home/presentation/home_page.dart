...
class _HomePageState extends State<HomePage> {
  ...
  // Profile is a top-level destination. Use go() instead of push() so the
  // destination cannot be hidden behind a stale nested navigation stack.
  void _openProfile() {
    if (!mounted) return;
    context.go('/profile');
  }
