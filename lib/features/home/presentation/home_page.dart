          ...
          child: CustomScrollView(
            ...
            slivers: [
              ...
              if (_loadingFeed)
                ...
                const SliverFillRemaining(hasScrollBody: false, child: Center(child: Padding(padding: EdgeInsets.all(32), child: Text('Your creator journey starts here.\nBe the first to share something worth seeing.', textAlign: TextAlign.center))))
              else
                SliverPadding(
            ...
            child: Card(
              ...
              child: InkWell(
                ...
                child: const Padding(
                  ...
                  child: Row(children: [Icon(Icons.emergency_outlined, size: 24), SizedBox(width: 9), Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text('Women Safety', style: TextStyle(fontWeight: FontWeight.w900)), SizedBox(height: 2), Text('Safety tools', style: TextStyle(fontSize: 11))]))]),
                ),
              ),
            ),
          ),
          ...
          Expanded(
            child: Card(
              ...
              child: InkWell(
                ...
                child: const Padding(
                  padding: EdgeInsets.all(12),
                  child: Row(children: [Icon(Icons.child_care_rounded, size: 24), SizedBox(width: 9), Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text('Kids Space', style: TextStyle(fontWeight: FontWeight.w900)), SizedBox(height: 2), Text('Protected mode', style: TextStyle(fontSize: 11))]))]),
                ),
              ),
            ),
          ),
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          child: const Padding(
            ...
            child: Row(children: [ManoxMark(size: 42), SizedBox(width: 12), Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Text('Share your world', style: TextStyle(fontSize: 15, fontWeight: FontWeight.w800)), SizedBox(height: 3), Text('Photo  •  Video  •  Beat  •  Thought', style: TextStyle(fontSize: 11))])), Icon(Icons.add_circle_rounded, size: 30)]),
          ),
        ),
      ),
    );
