          ...
          child: Column(
            ...
            children: [
              Align(
                ...
                child: Text(
                  widget.initialBeat ? 'Upload a BEAT' : 'Add to your post',
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                hintText: widget.initialBeat ? 'Write a BEAT caption…' : 'Write a caption…',
            ...
            if (_isVideo && !widget.initialBeat)
              Card(
                child: SwitchListTile.adaptive(
                  ...
                  subtitle: const Text('Shows this video in the full-screen BEATS feed'),
                  value: _isBeat,
                  onChanged: _posting ? null : (value) => setState(() => _isBeat = value),
                ),
              ),
            if (widget.initialBeat)
              const Card(
                child: ListTile(
                  ...
                  title: Text('BEAT video', style: TextStyle(fontWeight: FontWeight.w800)),
              ...
              child: Column(
                children: [
                  ListTile(
                    ...
                    title: const Text('Quick edit', style: TextStyle(fontWeight: FontWeight.w800)),
                    subtitle: const Text('Trim • Crop • Filter • Text • Audio'),
                  ...
                  SwitchListTile.adaptive(
                    ...
                    value: _comments,
                    onChanged: _posting ? null : (value) => setState(() => _comments = value),
                  ),
                  if (_isVideo)
                    SwitchListTile.adaptive(
                      ...
                      value: _downloads,
                      onChanged: _posting ? null : (value) => setState(() => _downloads = value),
                    ),
                ],
              ),
            ),
                ...
                child: Padding(
                  ...
                  child: DropdownButtonFormField<String>(
                    ...
                    items: _kidsCategories
                        ...
                        .toList(),
                    onChanged: _posting ? null : (value) => setState(() => _kidsCategory = value ?? _kidsCategory),
                  ),
                ),
              ),
            const SizedBox(height: 8),
        ...
        child: Column(
          ...
          children: [
            const Padding(
              ...
              child: Align(
                alignment: Alignment.centerLeft,
                child: Text('Who can see this?', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w800)),
              ),
            ),
            for (final option in ['Everyone', 'Followers', 'Only me'])
              ListTile(
                leading: Icon(_audience == option ? Icons.radio_button_checked : Icons.radio_button_off),
                title: Text(option),
                onTap: () {
