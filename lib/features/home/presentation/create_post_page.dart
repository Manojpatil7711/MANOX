...
class _CreatePostPageState extends State<CreatePostPage> {
  ...
  static const List<String> _kidsCategories = [
          ...
          child: Column(
            ...
            children: [
              ...
              Row(children: [
                ...
                if (!widget.initialBeat) ...[
                  const SizedBox(width: 10),
                  Expanded(child: _sourceTile(sheet, Icons.camera_alt_outlined, 'Photo', () => _pickMedia(video: false, source: ImageSource.camera))),
                ],
              ]),
  ...
  Future<void> _publish() async {
    ...
    try {
      ...
      await _repository.createPost(
        ...
        visibility: _audience == 'Only me' ? 'private' : (_audience == 'Followers' ? 'followers' : 'public'),
    ...
    return Scaffold(
      ...
      body: SafeArea(child: ListView(padding: const EdgeInsets.fromLTRB(16, 12, 16, 32), children: [
        ...
        Card(child: Column(children: [
          ...
          if (_isVideo) SwitchListTile.adaptive(secondary: const Icon(Icons.download_outlined), title: const Text('Allow downloads'), value: _downloads, onChanged: _posting ? null : (value) => setState(() => _downloads = value)),
        ])),
        const SizedBox(height: 10),
  ...
  Widget _emptyMedia() => InkWell(
    ...
    child: Container(height: 300, decoration: BoxDecoration(borderRadius: BorderRadius.circular(20), border: Border.all(color: Theme.of(context).dividerColor)), child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
